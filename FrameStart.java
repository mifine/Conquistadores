...
public class FrameStart extends javax.swing.JFrame {
     ...
     */
    public FrameStart(Board boardCreated) {
        this.boardGame = boardCreated;
        this.playerColor = new Color(102, 102, 255);                                // This is the default color
        initComponents();
    }
    ...
    private void changePlayerColor(String color) {
        ...
        //    this.frameGameMic.setColor(color);
    }

    private void launchNewGame() {
        final Frame frameGame = new Frame();
